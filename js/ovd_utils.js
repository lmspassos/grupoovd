 $(document).ready(function(){
	...
	//INCLUDE BOX MARCAS
	$('#boxMarcas').load('includes/box-marcas.html', function(){});

	//INCLUDE FOOTER
	$('#footer').load('includes/footer.html', function(){});

	//INCLUDE MODAL CAMPANHAS
	$('#modalcampanhas').load('includes/modal_campanhas.html', function(){});
     
     //INCLUDE LISTA KIT IMPRENSA
	$('#kit_imprensa_lista').load('https://www.ovd.com.br/site/presskit/includes/lista.php', function(){});
